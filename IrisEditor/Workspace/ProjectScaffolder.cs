...
namespace IrisEditor.Workspace
{
    internal static class ProjectScaffolder
    {
        ...
        private const string GeneratedHeader = """
            <!--
              Regenerated by the Iris editor every time the project is opened.
              Manual edits are lost on the next open.
              Contains machine-specific engine paths, so it is not tracked in source control.

              Release builds are windowed (no console). To keep a console in Release,
              set <IrisConsoleWindow>true</IrisConsoleWindow> in the game .csproj.
            -->
            """;
